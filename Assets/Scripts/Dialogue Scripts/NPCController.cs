...
public class NPCController : MonoBehaviour {
    ...
    private void OnTriggerStay2D(Collider2D other)
    {
		...
		if (other.gameObject.CompareTag("Player") && (PersistenceController.instance.dialogueState.autoTalk || (Input.touchCount == 1 && Input.GetTouch(0).phase == TouchPhase.Began)))
        {
